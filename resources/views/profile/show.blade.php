...
<div class="row">
    ...
    <div class="col-12 col-xl-6 d-flex align-items-stretch">
        <div class="card w-100">
            ...
            <div class="card-body p-9">
                ...
                @endif
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Nombre(s)</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->name}}</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Apellido(s)</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->lastname}}</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Sexo</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->gender_label}}</span>
                    </div>
                </div>
                <div class="row mb-7">
                ...
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Correo electrónico alternativo</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->secondary_email}}</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Télefono móvil</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->mobile_phone}}</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Télefono Alternativo</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->office_phone}}</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12 col-xl-6 d-flex align-items-stretch">
        <div class="card w-100">
            <div class="card-header cursor-pointer">
                <div class="card-title m-0">
                    <h3 class="fw-bold m-0">Información Laboral</h3>
                </div>
            </div>
            <div class="card-body p-9">
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">Departamento</label>
                    <div class="col-lg-8">
                ...
                <div class="row mb-7">
                    ...
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->position}}</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">CURP</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->curp}}</span>
                    </div>
                </div>
                <div class="row mb-7">
                    <label class="col-lg-4 fw-semibold text-muted">NSS</label>
                    <div class="col-lg-8">
                        <span class="fw-bold fs-6 text-gray-800">{{$user->nss_imss}}</span>
                    </div>
                </div>
            </div>
        </div>
