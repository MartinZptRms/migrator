...
<form onsubmit="loading();" method="POST" action="{{route('connections.store')}}" enctype="multipart/form-data">
    @csrf
    <div class="row">
                ...
                <div class="card-body pt-5">
                    <div class="row">
                        ...
                        <div class="col-md-12 col-lg-10 col-xl-10 mb-8">
                            ...
                            <input type="text" class="form-control" placeholder="Host" id="host" name="host" value="{{old('host')}}"/>
                            @error('host')
                        ...
                        <div class="col-md-12 col-lg-2 col-xl-2 mb-8">
                            ...
                            <input type="text" class="form-control" placeholder="Puerto" id="port" name="port" value="{{old('port','3306')}}"/>
                            @error('port')
                        ...
                        <div class="col-md-12 col-lg-6 col-xl-6 mb-8">
                            ...
                            <input type="password" class="form-control" placeholder="Contraseña" id="password" name="password" value="{{old('password')}}"/>
                            @error('password')
