...
class KualionDataRepository
{
    ...
    public function facturacionUCTable()
    {
        $params = [
            ...
            "sistema" => "SIN",
            "participante" =>config('app.CENACE_PASSWORD'),
            "subcuenta" => null
        ];
        $dateDataArray = $this->getFacturasEmitidas(155, $params, $this->startDate, $this->endDate);
    ...
    */
    public function getFacturasEmitidas($teamId, $params, $startDate, $endDate)
    {
